...
import { getEvent, deleteInvitee, getAttendees, checkIsInvitee, completeEvent } from '../../Services/Events';
                ...
                <div className="row align-items-start">
                        ...
                        (
                            <div className="col-lg-7 col-md-10 col-10 mx-auto text-start mb-5 pe-lg-5">
                                <div className="d-flex justify-content-between align-items-end">
                                    <h1 className="heading-lvl-one d-flex align-items-center">{event?.name}</h1>
                                </div>
                                <div className="row justify-content-start mt-3">
                                    <div className="col-md-4 col-sm-6 mb-5">
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="host-info ms-2">
                                                ...
                                                <p>{user?._id == event?.user ? 'You' : event?.user_detail?.name}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4 col-sm-6 mb-5">
                                    ...
                                    <div className="col-xl-7 col-md-8">
                                        ...
                                        event?.media && (
                                            <div className="row justify-content-between align-items-center mb-5">
                                                <div className="col-sm-6 mb-2">
                                                    <h4 className="fs-30 font-weight-light">Media <button onClick={()=> toggleSound()} className="volume-btn"><i className="fas fa-volume-up ms-2" /></button></h4>
                                                </div>
                                                <div className="col-sm-4 mb-2">
                                                    <a onClick={()=> playMedia()} className="cursor text-white font-weight-light"> {isPlaying?'Stop Playing':'Start Playing'} </a>
                                                </div>
                                                ...
                                                {
                                                    isPlaying? 
                                                    <img src="images/play-waves.gif" className="img-fluid"/>
                                                    :
                                                    <img src="images/play-waves.png" className="img-fluid"/>
                                                }
                                        ...
                                        <div className="row justify-content-between align-items-baseline mb-4">
                                            ...
                                            <div className="col-sm-6 mb-2">
                                                <p className="text-white mb-0 font-weight-light">({event?.attendees_count || 0} people joined)</p>
                                            </div>
                                            {/* attendees list */}
                                                            ...
                                                            <Fragment key={itemIndex}>
                                                                <div className="col-10 my-3">
                                                                    <div className="d-flex align-items-center justify-content-start">
                                                                        <img crossOrigin='anonymous' src={item?.user?.user_image} alt="" className="img-fluid me-3" />
                                                                        <p>{item?.user?.name}</p>
                                                                    </div>
                                                                </div>
                                                                <div className="col-2 my-3 text-end">
                                                                    {event?.user == user?._id && <button onClick={() => removeInvitee(item?._id, itemIndex)} type="button" className="cut-btn red"><i className="fas fa-times" /></button>}
                                                                </div>
                                                            </Fragment>
                                                        ))
                                                    }
                                            ...
                                            <div className="col-12">
                                                <a onClick={() => endEvent()} className="cursor btn gold-btn-solid d-inline-block eq-width-btn px-5">{event?.user == user?._id?'Exit Event': 'End Event'}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-5 col-8 mx-auto text-center mb-5">
                        <div className="position-relative">
                            ...
                            <button type="button" className="zoom-btn" id="zoom-btn" data-bs-toggle="modal" data-bs-target="#zoomImage"><i className="fas fa-search-plus"></i></button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="modal fade" id="zoomImage" tabindex="-1" aria-labelledby="giftModal" aria-hidden="true">
